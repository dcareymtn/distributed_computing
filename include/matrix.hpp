...

{
    ...
    std::vector<std::vector<Matrix> > parBreakZeroPadForFilt( int nRowBreak, int nColBreak, int filtNRows, int FiltNCols ) const;
	...
	void copy_to_c_zero_padded_blocks( double *newMArray, int nRowBreak, int nColBreak, int filtNRows, int filtNCols ) const;
